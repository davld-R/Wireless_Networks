    ...
    public void run() {
        ...
        try {
            ...
            while (true) {    
                ...
                PrecioCombustible pc=(PrecioCombustible)in.readObject();
                lbl_Precio1.setText("Precio:"+pc.getPrecio_G());
                lbl_PrecioGE.setText("Precio GE:"+pc.getPrecios_GE());
                lbl_Impuesto.setText("Retención por "+pc.getImpuesto());
            }            
